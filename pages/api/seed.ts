...
export default async function handler(
  ...
  const indiancusineId =
    cusines.find((cusine) => cusine.name === "indian")?.id || 1;
  const mexicancusineId =
    cusines.find((cusine) => cusine.name === "mexican")?.id || 1;
  const italiancusineId =
    cusines.find((cusine) => cusine.name === "italian")?.id || 1;
  ...
  await prisma.restaurant.createMany({
    data: [
      // INDIAN //
      {
        ...
        price: PRICE.REGULAR,
        description:
          "Vivaan is Modern Indian cusine serving dishes from different regions of India. We carefully select our ingredients and use them to make authentic Indian recipes and our chef puts his modern flair and twists to the dishes.",
        images: [
        ...
        slug: "vivaan-fine-indian-cusine-ottawa",
        location_id: ottawaLocationId,
        cusine_id: indiancusineId,
      },
      {
      ...
      },
      {
        ...
        description:
          "At Coconut Lagoon prepare yourselves for a most memorable journey through South Indian cusine and feast on high quality food of inimitable flavour, aroma and originality in the vibrant setting of Coconut Lagoon.",
        images: [
      ...
      // MEXICAN //
      {
        ...
        price: PRICE.REGULAR,
        description:
          "Eldorado Taco restaurant is excited to serve you traditional Mexican cusine, re-imagined with a distinct modern flair, in a stylish setting on Preston street. Striving to bring you some of Ottawa’s best Tacos, margaritas and Tequila. Reserve your table now!",
        images: [
